...
public class PointRuleEngineImpl implements PointRuleEngine {  
    ...
    /** 
     * 获取测试规则文件 
     *  D:/me/work/project/droolsdemo/src/main/java/com/linyw/droolsdemo/drl
     * @return 
     */  
    private List<String> getTestDrlFile() {  
        List<String> drlFilePath = new ArrayList<String>();  
        drlFilePath  
                .add("D:/me/work/project/droolsdemo/src/main/java/com/linyw/droolsdemo/drl/addpoint.drl");
        drlFilePath  
                .add("D:/me/work/project/droolsdemo/src/main/java/com/linyw/droolsdemo/drl/subpoint.drl");
